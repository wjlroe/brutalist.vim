...
exec 'highlight Tag guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=underline cterm=underline'
exec 'highlight Underlined guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=underline cterm=underline'
exec 'highlight Comment guifg=' . s:guifg_dim . ' ctermfg=' . s:ctermfg_dim . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=italic cterm=italic'
...
exec 'highlight Include guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=italic cterm=italic'
exec 'highlight Define guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=italic cterm=italic'
exec 'highlight Macro guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=italic cterm=italic'
exec 'highlight PreCondit guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=italic cterm=italic'
exec 'highlight Type guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=underline cterm=underline'
...
exec 'highlight IncSearch guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg_highlight_3 . ' ctermbg=' . s:ctermbg_highlight_3 . ' gui=italic cterm=italic'
exec 'highlight Search guifg=' . s:guifg . ' ctermfg=' . s:ctermfg . ' guibg=' . s:guibg_highlight_3 . ' ctermbg=' . s:ctermbg_highlight_3 . ' gui=italic cterm=italic'
